    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
       ...
       <div className='mt-20'>
          ...
          <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae tenetur soluta, accusamus velit illum numquam repellat beatae animi vel, fugit labore molestiae quam minus repudiandae maxime, distinctio cum fuga odit!</p>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae tenetur soluta, accusamus velit illum numquam repellat beatae animi vel, fugit labore molestiae quam minus repudiandae maxime, distinctio cum fuga odit!`</p>
          </div>
       </div>
